...
import ProcDescription.Registers.Register16bits
import ProcDescription.Registers.Register8bits
...
class Z80 : IProcessorDescription {
    val r8: Array<Register8bits> = arrayOf(
            ...
            Register8bits("H", 48), Register8bits("C", 56)
    )
    ...
    val r8backtick: Array<Register8bits> = arrayOf(
            ...
            Register8bits("H", 112), Register8bits("C", 120)
    )
